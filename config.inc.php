...
$rcmail_config['amavisspamsettings_ldap_host'] = 'localhost';

// LDAP server port to connect to
// Default: '389'
$rcmail_config['amavisspamsettings_ldap_port'] = '389';

// LDAP version
// Default: '3'
$rcmail_config['amavisspamsettings_ldap_version'] = '3';

// LDAP base name (root directory)
// Exemple: 'dc=exemple,dc=com'
$rcmail_config['amavisspamsettings_ldap_basedn'] = 'dc=company,dc=ch';

// LDAP Admin DN
// Default: value
$rcmail_config['amavisspamsettings_ldap_adminDN'] = 'cn=admin,dc=company,dc=ch';

// LDAP Admin Password
// Default: value
$rcmail_config['amavisspamsettings_ldap_adminPW'] = '';

$rcmail_config['amavisspamsettings_ldap_user_search_attribute'] = 'mail';

// Default Quantaine-Mailaddress
$rcmail_config['amavisspamsettings_ldap_quarantaine_mail_address'] = '';
